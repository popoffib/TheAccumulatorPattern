...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 4
    answer = count_cosines_from(5, 13, 0.45)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(8, 17, 0.17)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 5
    answer = count_cosines_from(2, 15, 0.23)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(1, 8, 0.37)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 4
    answer = count_cosines_from(5, 14, 0.46)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.509523  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(5, 7)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.217857  # This is APPROXIMATELY the correct answer.
